...
const basic = {
  ...
  count: (database, table, tx) => async (query, groupKey, parentQuery) => await aggregate(database, table, query, tx, 'count', groupKey, parentQuery),
  avg: (database, table, tx) => async (query, groupKey, parentQuery) => await aggregate(database, table, query, tx, 'avg', groupKey, parentQuery),
  min: (database, table, tx) => async (query, groupKey, parentQuery) => await aggregate(database, table, query, tx, 'min', groupKey, parentQuery),
  max: (database, table, tx) => async (query, groupKey, parentQuery) => await aggregate(database, table, query, tx, 'max', groupKey, parentQuery),
  sum: (database, table, tx) => async (query, groupKey, parentQuery) => await aggregate(database, table, query, tx, 'sum', groupKey, parentQuery),
